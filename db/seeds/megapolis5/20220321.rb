...
ActiveRecord::Base.transaction do
  ...
  g.goals.create(team_id: 1, player_id: 54, assist_player_id: 5)
  g = Game.create(day_id: s5d16.id, team_left_id: 1, goals_left: 1, goals_right: 0, team_right_id: 3)
  g.goals.create(team_id: 1, player_id: 2, assist_player_id: 29)
  ...
  g.goals.create(team_id: 2, player_id: 4, assist_player_id: 12)
  g.goals.create(team_id: 2, player_id: 11, assist_player_id: 58)
  ...
  g.goals.create(team_id: 4, player_id: 68, assist_player_id: 14)
  g.goals.create(team_id: 4, player_id: 8, assist_player_id: 68)
  ...
  g.goals.create(team_id: 2, player_id: 11, assist_player_id: 12)
  g.goals.create(team_id: 4, player_id: 68, assist_player_id: nil)
  ...
  g.goals.create(team_id: 3, player_id: 42, assist_player_id: nil)
  g.goals.create(team_id: 3, player_id: 65, assist_player_id: 21)
  ...
  g.goals.create(team_id: 4, player_id: 68, assist_player_id: nil)
  g.goals.create(team_id: 2, player_id: 42, assist_player_id: 4)
