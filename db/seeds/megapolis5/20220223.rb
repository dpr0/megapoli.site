...
ActiveRecord::Base.transaction do
  ...
  g.goals.create(season_id: @season_id, team_id: 3, player_id: 7, assist_player_id: nil)
  g.goals.create(season_id: @season_id, team_id: 3, player_id: 7, assist_player_id: nil)
  ...
  g.goals.create(season_id: @season_id, team_id: 3, player_id: 57, assist_player_id: 61)
  ...
  g.goals.create(season_id: @season_id, team_id: 3, player_id: 21, assist_player_id: 44)
  ...
  g = Game.create(day_id: s5d13.id, team_left_id: 2, goals_left: 2, goals_right: 0, team_right_id: 1)
  g.goals.create(season_id: @season_id, team_id: 2, player_id: 23, assist_player_id: nil)
  g.goals.create(season_id: @season_id, team_id: 2, player_id: 4, assist_player_id: nil)
  g = Game.create(day_id: s5d13.id, team_left_id: 2, goals_left: 2, goals_right: 0, team_right_id: 3)
  g.goals.create(season_id: @season_id, team_id: 2, player_id: 7, assist_player_id: nil)
  g.goals.create(season_id: @season_id, team_id: 2, player_id: 7, assist_player_id: nil)
