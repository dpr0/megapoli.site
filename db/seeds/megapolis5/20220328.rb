...
ActiveRecord::Base.transaction do
  ...
  g.goals.create(season_id: @season_id, team_id: 2, player_id: 9, assist_player_id: 1)
  ...
  g.goals.create(season_id: @season_id, team_id: 3, player_id: 17, assist_player_id: 22)
  g = day.games.create(team_left_id: 3, goals_left: 2, goals_right: 0, team_right_id: 4)
  g.goals.create(season_id: @season_id, team_id: 3, player_id: 22, assist_player_id: nil)
  g.goals.create(season_id: @season_id, team_id: 3, player_id: 8, assist_player_id: 21)
  ...
  g.goals.create(season_id: @season_id, team_id: 3, player_id: 8, assist_player_id: 57)
  ...
  g.goals.create(season_id: @season_id, team_id: 2, player_id: 4, assist_player_id: 10)
  g.goals.create(season_id: @season_id, team_id: 1, player_id: 18, assist_player_id: nil)
  g = day.games.create(team_left_id: 4, goals_left: 0, goals_right: 2, team_right_id: 3)
  g.goals.create(season_id: @season_id, team_id: 3, player_id: 8, assist_player_id: 17)
  g.goals.create(season_id: @season_id, team_id: 3, player_id: 57, assist_player_id: 22)
  g = day.games.create(team_left_id: 1, goals_left: 2, goals_right: 0, team_right_id: 3)
  g.goals.create(season_id: @season_id, team_id: 1, player_id: 29, assist_player_id: nil)
  g.goals.create(season_id: @season_id, team_id: 1, player_id: 18, assist_player_id: nil)
  ...
  g = day.games.create(team_left_id: 4, goals_left: 0, goals_right: 2, team_right_id: 2)
  g.goals.create(season_id: @season_id, team_id: 2, player_id: 1, assist_player_id: nil)
  g.goals.create(season_id: @season_id, team_id: 2, player_id: 4, assist_player_id: 9)
