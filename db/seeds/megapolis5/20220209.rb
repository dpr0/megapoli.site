...
ActiveRecord::Base.transaction do
  ...
  g.goals.create(season_id: @season_id, team_id: 2, player_id: 8, assist_player_id: 12)
  ...
  g.goals.create(season_id: @season_id, team_id: 2, player_id: 8, assist_player_id: 1)
  g = Game.create(day_id: s5d10.id, team_left_id: 2, goals_left: 2, goals_right: 1, team_right_id: 3)
  ...
  g.goals.create(season_id: @season_id, team_id: 1, player_id: 6, assist_player_id: 2)
  g = Game.create(day_id: s5d10.id, team_left_id: 2, goals_left: 2, goals_right: 0, team_right_id: 1)
  g.goals.create(season_id: @season_id, team_id: 2, player_id: 8, assist_player_id: 4)
  g.goals.create(season_id: @season_id, team_id: 2, player_id: 8, assist_player_id: 1)
  ...
  g.goals.create(season_id: @season_id, team_id: 3, player_id: 57, assist_player_id: 49)
  g.goals.create(season_id: @season_id, team_id: 1, player_id: 2, assist_player_id: 18)
  g.goals.create(season_id: @season_id, team_id: 1, player_id: 18, assist_player_id: 1)
  g = Game.create(day_id: s5d10.id, team_left_id: 2, goals_left: 2, goals_right: 0, team_right_id: 1)
  g.goals.create(season_id: @season_id, team_id: 2, player_id: 9, assist_player_id: nil)
  g.goals.create(season_id: @season_id, team_id: 2, player_id: 8, assist_player_id: nil)
  g = Game.create(day_id: s5d10.id, team_left_id: 2, goals_left: 2, goals_right: 0, team_right_id: 3)
  g.goals.create(season_id: @season_id, team_id: 2, player_id: 1, assist_player_id: 8)
  g.goals.create(season_id: @season_id, team_id: 2, player_id: 8, assist_player_id: 4)
  g = Game.create(day_id: s5d10.id, team_left_id: 2, goals_left: 2, goals_right: 2, team_right_id: 1)
  g.goals.create(season_id: @season_id, team_id: 2, player_id: 8, assist_player_id: 12)
  g.goals.create(season_id: @season_id, team_id: 1, player_id: 18, assist_player_id: nil)
  g.goals.create(season_id: @season_id, team_id: 1, player_id: 38, assist_player_id: 22)
  g.goals.create(season_id: @season_id, team_id: 2, player_id: 8, assist_player_id: 1)
