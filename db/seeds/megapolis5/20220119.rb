...
ActiveRecord::Base.transaction do
  ...
  g.goals.create(team_id: 4, player_id: 8, assist_player_id: 6)
  ...
  g.goals.create(team_id: 4, player_id: 8, assist_player_id: 23)
  ...
  g.goals.create(team_id: 4, player_id: 8, assist_player_id: nil)
  g.goals.create(team_id: 4, player_id: 29, assist_player_id: nil)
  ...
  g.goals.create(team_id: 3, player_id: 4, assist_player_id: nil)
  g = Game.create(day_id: s5d4.id, team_left_id: 1, goals_left: 0, goals_right: 2, team_right_id: 3)
  g.goals.create(team_id: 3, player_id: 61, assist_player_id: 4)
