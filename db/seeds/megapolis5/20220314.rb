...
ActiveRecord::Base.transaction do
  ...
  g.goals.create(team_id: 3, player_id: 17, assist_player_id: 57)
  ...
  g.goals.create(team_id: 2, player_id: 54, assist_player_id: 1)
  g = Game.create(day_id: s5d16.id, team_left_id: 1, goals_left: 2, goals_right: 0, team_right_id: 4)
  g.goals.create(team_id: 1, player_id: 18, assist_player_id: 38)
  g.goals.create(team_id: 1, player_id: 6, assist_player_id: nil)
  g = Game.create(day_id: s5d16.id, team_left_id: 1, goals_left: 1, goals_right: 1, team_right_id: 2)
  g.goals.create(team_id: 1, player_id: 29, assist_player_id: 14)
