...
ActiveRecord::Base.transaction do
  ...
  g.goals.create(season_id: @season_id, team_id: 3, player_id: 49, assist_player_id: 21)
  ...
  g.goals.create(season_id: @season_id, team_id: 2, player_id: 7, assist_player_id: 12)
  g.goals.create(season_id: @season_id, team_id: 1, player_id: nil, assist_player_id: nil)
  ...
  g.goals.create(season_id: @season_id, team_id: 2, player_id: 7, assist_player_id: 1)
  ...
  g.goals.create(season_id: @season_id, team_id: 3, player_id: 48, assist_player_id: 6)
  g.goals.create(season_id: @season_id, team_id: 3, player_id: nil, assist_player_id: nil)
  ...
  g.goals.create(season_id: @season_id, team_id: 1, player_id: 6, assist_player_id: 18)
  g = Game.create(day_id: s5d11.id, team_left_id: 1, goals_left: 1, goals_right: 2, team_right_id: 2)
  g.goals.create(season_id: @season_id, team_id: 2, player_id: 1, assist_player_id: 7)
  g.goals.create(season_id: @season_id, team_id: 1, player_id: 2, assist_player_id: 6)
  g.goals.create(season_id: @season_id, team_id: 2, player_id: 4, assist_player_id: 23)
  g = Game.create(day_id: s5d11.id, team_left_id: 3, goals_left: 2, goals_right: 0, team_right_id: 2)
  g.goals.create(season_id: @season_id, team_id: 3, player_id: nil, assist_player_id: nil)
  g.goals.create(season_id: @season_id, team_id: 3, player_id: nil, assist_player_id: nil)
