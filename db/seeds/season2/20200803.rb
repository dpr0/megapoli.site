...
s2d5 = Day.create(sport_id: 1, season_id: 2, date: '03.08.2020'.to_date)
s2d5t1p1 = s2d5.day_players.create(season_id: 2, team_id: 1, player_id: 23) # врач
s2d5t1p2 = s2d5.day_players.create(season_id: 2, team_id: 1, player_id: 5) # алихан
s2d5t1p3 = s2d5.day_players.create(season_id: 2, team_id: 1, player_id: 18) # дима
s2d5t1p4 = s2d5.day_players.create(season_id: 2, team_id: 1, player_id: 2) # коля
s2d5t1p5 = s2d5.day_players.create(season_id: 2, team_id: 1, player_id: 33) # макс а

s2d5t2p1 = s2d5.day_players.create(season_id: 2, team_id: 2, player_id: 41) # мага
s2d5t2p2 = s2d5.day_players.create(season_id: 2, team_id: 2, player_id: 13) # араз
s2d5t2p3 = s2d5.day_players.create(season_id: 2, team_id: 2, player_id:  3) # ден
s2d5t2p4 = s2d5.day_players.create(season_id: 2, team_id: 2, player_id: 12) # саня
s2d5t2p5 = s2d5.day_players.create(season_id: 2, team_id: 2, player_id: 7) # сандро
s2d5t2p5 = s2d5.day_players.create(season_id: 2, team_id: 2, player_id: 10) # виталик

s2d5t3p1 = s2d5.day_players.create(season_id: 2, team_id: 3, player_id: 17) # андр
s2d5t3p1 = s2d5.day_players.create(season_id: 2, team_id: 3, player_id: 28) # евр
s2d5t3p2 = s2d5.day_players.create(season_id: 2, team_id: 3, player_id: 42) # сергей
s2d5t3p2 = s2d5.day_players.create(season_id: 2, team_id: 3, player_id:  8) # аргентина
s2d5t3p2 = s2d5.day_players.create(season_id: 2, team_id: 3, player_id:  8) # валера

s2d5t4p1 = s2d5.day_players.create(season_id: 2, team_id: 4, player_id:  9) # вова
s2d5t4p2 = s2d5.day_players.create(season_id: 2, team_id: 4, player_id: 47) # анк
s2d5t4p3 = s2d5.day_players.create(season_id: 2, team_id: 4, player_id: 14) # саша
...
g02.goals.create(season_id: 2, team_id: 1, player_id: 33)
g02.goals.create(season_id: 2, team_id: 4, player_id: 7)
g03 = Game.create(day_id: s2d5.id, team_left_id: 2, goals_left: 0, goals_right: 1, team_right_id: 3)
g03.goals.create(season_id: 2, team_id: 3, player_id: 44)
g04 = Game.create(day_id: s2d5.id, team_left_id: 4, goals_left: 1, goals_right: 0, team_right_id: 3)
g04.goals.create(season_id: 2, team_id: 4, player_id: 47)
...
g09.goals.create(season_id: 2, team_id: 1, player_id: 14)
g10 = Game.create(day_id: s2d5.id, team_left_id: 4, goals_left: 1, goals_right: 0, team_right_id: 1)
g10.goals.create(season_id: 2, team_id: 4, player_id: 12)
...
g12.goals.create(season_id: 2, team_id: 2, player_id: 13)
...
g16.goals.create(season_id: 2, team_id: 1, player_id: 14)
g17 = Game.create(day_id: s2d5.id, team_left_id: 3, goals_left: 1, goals_right: 1, team_right_id: 1)
g17.goals.create(season_id: 2, team_id: 3, player_id: 42)
...
g19.goals.create(season_id: 2, team_id: 3, player_id: 28)
g19.goals.create(season_id: 2, team_id: 1, player_id: 14)
