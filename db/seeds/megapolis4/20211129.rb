ActiveRecord::Base.transaction do
  ...
  g2456.goals.create(season_id: @season_id, team_id: 2, player_id: 13, assist_player_id: nil)
  g2456.goals.create(season_id: @season_id, team_id: 3, player_id: 8, assist_player_id: 45)
  ...
  g2459.goals.create(season_id: @season_id, team_id: 3, player_id: 45, assist_player_id: 8)
