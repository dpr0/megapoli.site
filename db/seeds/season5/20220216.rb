...
ActiveRecord::Base.transaction do
  s5d11 = Day.create(sport_id: 1, season_id: 5, date: '16.02.2022'.to_date)
  s5d11.day_players.create(season_id: 5, team_id: 1, player_id:  2)
  s5d11.day_players.create(season_id: 5, team_id: 1, player_id:  5)
  s5d11.day_players.create(season_id: 5, team_id: 1, player_id:  6)
  s5d11.day_players.create(season_id: 5, team_id: 1, player_id: 14)
  s5d11.day_players.create(season_id: 5, team_id: 1, player_id: 18)
  s5d11.day_players.create(season_id: 5, team_id: 1, player_id: 38)

  s5d11.day_players.create(season_id: 5, team_id: 2, player_id:  4)
  s5d11.day_players.create(season_id: 5, team_id: 2, player_id:  7)
  s5d11.day_players.create(season_id: 5, team_id: 2, player_id:  1)
  s5d11.day_players.create(season_id: 5, team_id: 2, player_id: 12)
  s5d11.day_players.create(season_id: 5, team_id: 2, player_id: 23)
  s5d11.day_players.create(season_id: 5, team_id: 2, player_id: 58)

  s5d11.day_players.create(season_id: 5, team_id: 3, player_id:  9)
  s5d11.day_players.create(season_id: 5, team_id: 3, player_id: 21)
  s5d11.day_players.create(season_id: 5, team_id: 3, player_id: 22)
  s5d11.day_players.create(season_id: 5, team_id: 3, player_id: 42)
  s5d11.day_players.create(season_id: 5, team_id: 3, player_id: 48)
  ...
  g.goals.create(season_id: 5, team_id: 3, player_id: 49, assist_player_id: 21)
  ...
  g.goals.create(season_id: 5, team_id: 2, player_id: 7, assist_player_id: 12)
  g.goals.create(season_id: 5, team_id: 1, player_id: nil, assist_player_id: nil)
  ...
  g.goals.create(season_id: 5, team_id: 2, player_id: 7, assist_player_id: 1)
  ...
  g.goals.create(season_id: 5, team_id: 3, player_id: 48, assist_player_id: 6)
  g.goals.create(season_id: 5, team_id: 3, player_id: nil, assist_player_id: nil)
  ...
  g.goals.create(season_id: 5, team_id: 1, player_id: 6, assist_player_id: 18)
  g = Game.create(day_id: s5d11.id, team_left_id: 1, goals_left: 1, goals_right: 2, team_right_id: 2)
  g.goals.create(season_id: 5, team_id: 2, player_id: 1, assist_player_id: 7)
  g.goals.create(season_id: 5, team_id: 1, player_id: 2, assist_player_id: 6)
  g.goals.create(season_id: 5, team_id: 2, player_id: 4, assist_player_id: 23)
  g = Game.create(day_id: s5d11.id, team_left_id: 3, goals_left: 2, goals_right: 0, team_right_id: 2)
  g.goals.create(season_id: 5, team_id: 3, player_id: nil, assist_player_id: nil)
  g.goals.create(season_id: 5, team_id: 3, player_id: nil, assist_player_id: nil)
