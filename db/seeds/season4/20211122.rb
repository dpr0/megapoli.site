ActiveRecord::Base.transaction do
  ...
  g2433.goals.create(season_id: 4, team_id: 2, player_id: , assist_player_id: nil)
  g2433.goals.create(season_id: 4, team_id: 2, player_id: , assist_player_id: nil)
  g2433.goals.create(season_id: 4, team_id: 3, player_id: , assist_player_id: nil)
  g2434 = Game.create(day_id: s4d22.id, team_left_id: 2, goals_left: 1, goals_right: 1, team_right_id: 1)
  g2434.goals.create(season_id: 4, team_id: 2, player_id: , assist_player_id: nil)
  g2434.goals.create(season_id: 4, team_id: 1, player_id: , assist_player_id: nil)
  g2435 = Game.create(day_id: s4d22.id, team_left_id: 3, goals_left: 0, goals_right: 2, team_right_id: 4)
  g2435.goals.create(season_id: 4, team_id: 4, player_id: , assist_player_id: nil)
  g2435.goals.create(season_id: 4, team_id: 4, player_id: , assist_player_id: nil)
  g2436 = Game.create(day_id: s4d22.id, team_left_id: 1, goals_left: 2, goals_right: 0, team_right_id: 4)
  g2436.goals.create(season_id: 4, team_id: 1, player_id: , assist_player_id: nil)
  g2436.goals.create(season_id: 4, team_id: 1, player_id: , assist_player_id: nil)
  g2437 = Game.create(day_id: s4d22.id, team_left_id: 1, goals_left: 1, goals_right: 0, team_right_id: 2)
  g2437.goals.create(season_id: 4, team_id: 1, player_id: , assist_player_id: nil)
  ...
  g2439.goals.create(season_id: 4, team_id: 4, player_id: , assist_player_id: nil)
  g2439.goals.create(season_id: 4, team_id: 2, player_id: , assist_player_id: nil)
  ...
  g2441.goals.create(season_id: 4, team_id: 4, player_id: , assist_player_id: nil)
  g2441.goals.create(season_id: 4, team_id: 4, player_id: , assist_player_id: nil)
  g2442 = Game.create(day_id: s4d22.id, team_left_id: 4, goals_left: 1, goals_right: 2, team_right_id: 3)
  g2442.goals.create(season_id: 4, team_id: 4, player_id: , assist_player_id: nil)
  g2442.goals.create(season_id: 4, team_id: 3, player_id: , assist_player_id: nil)
  g2442.goals.create(season_id: 4, team_id: 3, player_id: , assist_player_id: nil)
  g2443 = Game.create(day_id: s4d22.id, team_left_id: 1, goals_left: 1, goals_right: 1, team_right_id: 3)
  g2443.goals.create(season_id: 4, team_id: 1, player_id: , assist_player_id: nil)
  g2443.goals.create(season_id: 4, team_id: 3, player_id: , assist_player_id: nil)
  g2444 = Game.create(day_id: s4d22.id, team_left_id: 2, goals_left: 1, goals_right: 0, team_right_id: 4)
  g2444.goals.create(season_id: 4, team_id: 2, player_id: , assist_player_id: nil)
  g2445 = Game.create(day_id: s4d22.id, team_left_id: 2, goals_left: 0, goals_right: 1, team_right_id: 1)
  g2445.goals.create(season_id: 4, team_id: 1, player_id: , assist_player_id: nil)
  g2446 = Game.create(day_id: s4d22.id, team_left_id: 3, goals_left: 0, goals_right: 2, team_right_id: 1)
  g2446.goals.create(season_id: 4, team_id: 1, player_id: , assist_player_id: nil)
  g2446.goals.create(season_id: 4, team_id: 1, player_id: , assist_player_id: nil)
  ...
  g2449.goals.create(season_id: 4, team_id: 1, player_id: , assist_player_id: nil)
