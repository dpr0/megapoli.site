...
o1.goals.create(team_id: 1, player_id: 19)
o1.goals.create(team_id: 1, player_id: 33)
o2 = Game.create(day_id: d15.id, team_left_id: 2, goals_left: 0, goals_right: 2, team_right_id: 1)
o2.goals.create(team_id: 1, player_id: 19)
o2.goals.create(team_id: 1, player_id: 25)
o3 = Game.create(day_id: d15.id, team_left_id: 3, goals_left: 0, goals_right: 2, team_right_id: 1)
o3.goals.create(team_id: 1, player_id: 9)
o3.goals.create(team_id: 1, player_id: 25)
...
o4.goals.create(team_id: 1, player_id: 25)
o4.goals.create(team_id: 1, player_id: 19)
o5 = Game.create(day_id: d15.id, team_left_id: 3, goals_left: 0, goals_right: 1, team_right_id: 1)
o5.goals.create(team_id: 1, player_id: 9)
...
o6.goals.create(team_id: 1, player_id: 33)
...
o11.goals.create(team_id: 1, player_id: 25)
o11.goals.create(team_id: 1, player_id: 6)
...
o17.goals.create(team_id: 1, player_id: 33)
o17.goals.create(team_id: 1, player_id: 25)
o18 = Game.create(day_id: d15.id, team_left_id: 2, goals_left: 0, goals_right: 2, team_right_id: 1)
o18.goals.create(team_id: 1, player_id: 25)
o18.goals.create(team_id: 1, player_id: 25)
...
o19.goals.create(team_id: 1, player_id: 25)
o19.goals.create(team_id: 1, player_id: 33)
o20 = Game.create(day_id: d15.id, team_left_id: 2, goals_left: 0, goals_right: 2, team_right_id: 1)
o20.goals.create(team_id: 1, player_id: 25)
o20.goals.create(team_id: 1, player_id: 25)
...
o21.goals.create(team_id: 1, player_id: 25)
o21.goals.create(team_id: 1, player_id: 25)
...
o22.goals.create(team_id: 1, player_id: 33)
