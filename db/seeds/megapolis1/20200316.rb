...
n9.goals.create(team_id: 3, player_id: 44)
...
n10.goals.create(team_id: 4, player_id: 45)
...
n11.goals.create(team_id: 3, player_id: 32)
n11.goals.create(team_id: 3, player_id: 46)
n12 = Game.create(day_id: d37.id, team_left_id: 3, goals_left: 1, goals_right: 1, team_right_id: 4)
n12.goals.create(team_id: 3, player_id: 46)
n12.goals.create(team_id: 4, player_id: 45)
...
n14.goals.create(team_id: 4, player_id: 14)
n15 = Game.create(day_id: d37.id, team_left_id: 3, goals_left: 1, goals_right: 2, team_right_id: 4)
n15.goals.create(team_id: 3, player_id: 46)
n15.goals.create(team_id: 4, player_id: 45)
...
n23.goals.create(team_id: 3, player_id: 46)
n23.goals.create(team_id: 3, player_id: 17)
n23.goals.create(team_id: 3, player_id: 46)
n23.goals.create(team_id: 3, player_id: 46)
