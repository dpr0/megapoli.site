...
s2d22 = Day.new(season_id: @season_id, date: '05.10.2020'.to_date)

s2d22.day_players.new(season_id: @season_id, team_id: 1, player_id:  2) # коля
s2d22.day_players.new(season_id: @season_id, team_id: 1, player_id:  5) # алихан
s2d22.day_players.new(season_id: @season_id, team_id: 1, player_id: 29) # макс к
s2d22.day_players.new(season_id: @season_id, team_id: 1, player_id: 6) # тигран
s2d22.day_players.new(season_id: @season_id, team_id: 1, player_id: 18) # дима
s2d22.day_players.new(season_id: @season_id, team_id: 1, player_id: 38) # миша
s2d22.day_players.new(season_id: @season_id, team_id: 1, player_id: 23) # серега

s2d22.day_players.new(season_id: @season_id, team_id: 2, player_id: 4) # шах
s2d22.day_players.new(season_id: @season_id, team_id: 2, player_id: 13) # араз
s2d22.day_players.new(season_id: @season_id, team_id: 2, player_id: 7) # сандро
s2d22.day_players.new(season_id: @season_id, team_id: 2, player_id: 10) # виталик
s2d22.day_players.new(season_id: @season_id, team_id: 2, player_id: 12) # саша
s2d22.day_players.new(season_id: @season_id, team_id: 2, player_id: 11) # саша
s2d22.day_players.new(season_id: @season_id, team_id: 2, player_id: 9) # вова

s2d22.day_players.new(season_id: @season_id, team_id: 3, player_id: 42) # серега
s2d22.day_players.new(season_id: @season_id, team_id: 3, player_id: 17) # андр
s2d22.day_players.new(season_id: @season_id, team_id: 3, player_id: 44) # валера
s2d22.day_players.new(season_id: @season_id, team_id: 3, player_id: 32) # игорь
s2d22.day_players.new(season_id: @season_id, team_id: 3, player_id: 22) # илья
s2d22.save
