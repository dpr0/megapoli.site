...
g02.goals.create(season_id: @season_id, team_id: 1, player_id: 33)
g02.goals.create(season_id: @season_id, team_id: 4, player_id: 7)
g03 = Game.create(day_id: s2d5.id, team_left_id: 2, goals_left: 0, goals_right: 1, team_right_id: 3)
g03.goals.create(season_id: @season_id, team_id: 3, player_id: 44)
g04 = Game.create(day_id: s2d5.id, team_left_id: 4, goals_left: 1, goals_right: 0, team_right_id: 3)
g04.goals.create(season_id: @season_id, team_id: 4, player_id: 47)
...
g09.goals.create(season_id: @season_id, team_id: 1, player_id: 14)
g10 = Game.create(day_id: s2d5.id, team_left_id: 4, goals_left: 1, goals_right: 0, team_right_id: 1)
g10.goals.create(season_id: @season_id, team_id: 4, player_id: 12)
...
g12.goals.create(season_id: @season_id, team_id: 2, player_id: 13)
...
g16.goals.create(season_id: @season_id, team_id: 1, player_id: 14)
g17 = Game.create(day_id: s2d5.id, team_left_id: 3, goals_left: 1, goals_right: 1, team_right_id: 1)
g17.goals.create(season_id: @season_id, team_id: 3, player_id: 42)
...
g19.goals.create(season_id: @season_id, team_id: 3, player_id: 28)
g19.goals.create(season_id: @season_id, team_id: 1, player_id: 14)
