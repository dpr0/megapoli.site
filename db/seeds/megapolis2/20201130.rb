...
g1407.goals.create(season_id: @season_id, team_id: 1, player_id: 18, assist_player_id: nil)
g1408 = Game.create(day_id: s2d28.id, team_left_id: 3, goals_left: 2, goals_right: 0, team_right_id: 1)
g1408.goals.create(season_id: @season_id, team_id: 3, player_id: nil, assist_player_id: nil)
g1408.goals.create(season_id: @season_id, team_id: 3, player_id: 21, assist_player_id: 50)
...
g1410.goals.create(season_id: @season_id, team_id: 1, player_id: 39, assist_player_id: 1)
g1411 = Game.create(day_id: s2d28.id, team_left_id: 1, goals_left: 0, goals_right: 2, team_right_id: 3)
g1411.goals.create(season_id: @season_id, team_id: 3, player_id: 42, assist_player_id: nil)
g1411.goals.create(season_id: @season_id, team_id: 3, player_id: 21, assist_player_id: nil)
g1412 = Game.create(day_id: s2d28.id, team_left_id: 2, goals_left: 1, goals_right: 0, team_right_id: 3)
g1412.goals.create(season_id: @season_id, team_id: 2, player_id: 4, assist_player_id: nil)
g1413 = Game.create(day_id: s2d28.id, team_left_id: 2, goals_left: 1, goals_right: 2, team_right_id: 1)
g1413.goals.create(season_id: @season_id, team_id: 2, player_id: 11, assist_player_id: nil)
g1413.goals.create(season_id: @season_id, team_id: 1, player_id: 38, assist_player_id: 1)
g1413.goals.create(season_id: @season_id, team_id: 1, player_id: 6, assist_player_id: nil)
...
g1415.goals.create(season_id: @season_id, team_id: 2, player_id: 3, assist_player_id: nil)
g1416 = Game.create(day_id: s2d28.id, team_left_id: 1, goals_left: 2, goals_right: 1, team_right_id: 2)
g1416.goals.create(season_id: @season_id, team_id: 1, player_id: 38, assist_player_id: 1)
g1416.goals.create(season_id: @season_id, team_id: 1, player_id: 6, assist_player_id: nil)
g1416.goals.create(season_id: @season_id, team_id: 2, player_id: 11, assist_player_id: nil)

g1417 = Game.create(day_id: s2d28.id, team_left_id: 1, goals_left: 2, goals_right: 0, team_right_id: 3)
g1417.goals.create(season_id: @season_id, team_id: 1, player_id: 39, assist_player_id: nil)
g1417.goals.create(season_id: @season_id, team_id: 1, player_id: 1, assist_player_id: nil)
g1418 = Game.create(day_id: s2d28.id, team_left_id: 1, goals_left: 2, goals_right: 1, team_right_id: 2)
g1418.goals.create(season_id: @season_id, team_id: 1, player_id: 38, assist_player_id: 18)
g1418.goals.create(season_id: @season_id, team_id: 1, player_id: 38, assist_player_id: 6)
g1418.goals.create(season_id: @season_id, team_id: 2, player_id: 24, assist_player_id: 4)
g1419 = Game.create(day_id: s2d28.id, team_left_id: 1, goals_left: 1, goals_right: 0, team_right_id: 3)
g1419.goals.create(season_id: @season_id, team_id: 1, player_id: 38, assist_player_id: nil)
g1420 = Game.create(day_id: s2d28.id, team_left_id: 1, goals_left: 2, goals_right: 0, team_right_id: 2)
g1420.goals.create(season_id: @season_id, team_id: 1, player_id: 1, assist_player_id: nil)
g1420.goals.create(season_id: @season_id, team_id: 1, player_id: 18, assist_player_id: nil)
...
g1422.goals.create(season_id: @season_id, team_id: 2, player_id: 4, assist_player_id: nil)
g1423 = Game.create(day_id: s2d28.id, team_left_id: 2, goals_left: 0, goals_right: 2, team_right_id: 1)
g1423.goals.create(season_id: @season_id, team_id: 1, player_id: 32, assist_player_id: 18)
g1423.goals.create(season_id: @season_id, team_id: 1, player_id: 18, assist_player_id: nil)
...
g1425.goals.create(season_id: @season_id, team_id: 2, player_id: 4, assist_player_id: nil)
g1425.goals.create(season_id: @season_id, team_id: 2, player_id: 4, assist_player_id: nil)
g1426 = Game.create(day_id: s2d28.id, team_left_id: 1, goals_left: 2, goals_right: 0, team_right_id: 2)
g1426.goals.create(season_id: @season_id, team_id: 1, player_id: 6, assist_player_id: 38)
g1426.goals.create(season_id: @season_id, team_id: 1, player_id: 6, assist_player_id: 38)
